...
class DYNAMO {
    ...
    private Node root;
    public  DYNAMO() throws IOException {
    ...
    public static void main (String[] args) throws IOException {
        ...
        while(q-->0)
        {
            ...
            System.out.println(ten.pow((n)).multiply(BigInteger.valueOf(2)).add(a));
            System.out.flush();
            BigInteger b=sc.nextBigInteger();
            System.out.println(ten.pow(n).subtract(b));
            System.out.flush();
            BigInteger d = sc.nextBigInteger();
            System.out.println(ten.pow(n).subtract(d));
            System.out.flush();
            int res=sc.nextInt();
